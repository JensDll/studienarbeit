...
jedoch haben auch sie gewisse Beeinträchtigungen, welche im Folgenden beschrieben werden.
...
\begin{example}
  ...
  Käufer Bob eine Bestellung wirklich getätigt hat,
...
Das RSA-Verfahren basiert auf der Annahme, dass ein effizientes Verfahren
für das Bestimmen der Primfaktorzerlegung
einer natürlichen Zahl gibt.
...
\begin{proof}
  ...
  \begin{align}
    ...
    \Leftrightarrow e \cdot d & = t \cdot \phif{N} + 1 \tag{$**$}
  \end{align}
