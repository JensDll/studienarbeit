...
einen gültigen Token enthalten, welcher als Teil des HTTP-Headers im
...
Fällt ein Token in die Hände des Angreifers, kann dieser
im Namen des Nutzers beliebig Anfragen durchführen, d.\,h. sowohl geheime Nachrichten
...
beschreibt hierbei die Konkatenation. \autoref{alg:data-protect} und \ref{alg:data-unprotect}
...
\noindent
Es ist jetzt zu sehen, warum es wichtig ist, eine Anfragen mit einem Benutzer zu verbinden:
...
Um die Qualität des Algorithmus zu beurteilen,
