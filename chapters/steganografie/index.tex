...
\begin{enumerate}
  ...
  \item \textbf{Integrität} einer Nachricht (Hashfunktion, MAC).
...
Es soll nun weiter auf die eben beschriebene Architektur eingegangen werden,
mit dem Ziel potenzielle Sicherheitsrisiken aufzudecken und Lösungen zu diskutieren.
...
Erlangt ein Angreifer Besitzt eines Tokens, kann dieser
im Namen des Opfers beliebig Anfragen durchführen, d. h. geheime Nachrichten
lesen und auch Nachrichten schreiben.
...
garantiert sein kann. Dennoch sollten Sicherheitsmaßnahem getroffen werden, um
...
der Ver- und Entschlüsselungsfunktion übergeben wird.
...
beschreibt die Konkatenation. \autoref{alg:data-protect} und \ref{alg:data-unprotect}
...
\noindent
Es ist jetzt zu sehen, warum eine Anfrage in Verbindung mit einem Benutzer
...
Um die Qualität des Algorithmus zu beurteilen, lohnt es sich vor allem einige
Beispiele anzusehen. Die steganografische Qualität des Verfahrens soll jetzt
...
\begin{figure}[h!]
  ...
  \caption{Schwarz. Größe 512 $\times$ 512 Pixel. 10 KB Nachricht, veränderte Pixel
    sind weiß eingefärbt.}
