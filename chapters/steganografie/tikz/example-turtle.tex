\begin{figure}[h!]
  ...
  \begin{tikzpicture}
    ...
    \node (original) {
      \begin{minipage}{0.45\textwidth}
        \includegraphics[width=1\textwidth]{turtle/turtle.png}
        \caption*{Original}
      \end{minipage}
    };
    \node [right= of original] (2mb) {
      \begin{minipage}{0.45\textwidth}
        \includegraphics[width=1\textwidth]{turtle/turtle-48.png}
        \caption*{48\,\% (\num{3.6}\,MB)}
      \end{minipage}
    };
    \node [below=0.5cm of original] (4mb) {
      \begin{minipage}{0.45\textwidth}
        \includegraphics[width=1\textwidth]{turtle/turtle-60.png}
        \caption*{60\,\% (\num{4.5}\,MB)}
      \end{minipage}
    };
    \node [below=0.5cm of 2mb] (6mb) {
      \begin{minipage}{0.45\textwidth}
        \includegraphics[width=1\textwidth]{turtle/turtle-72.png}
        \caption*{72\,\% (\num{5.4}\,MB)}
      \end{minipage}
    };
  ...
  \end{tikzpicture}
  \caption{Schildkröte mit einer von Größe 1368 $\times$ 1824 Pixel.
    Gute Bildqualität bis zu \num{3.6}\,MB versteckter Nachricht ($\bmax \approx \num{7.5}$\,MB).}
