...
\begin{enumerate}
  ...
  \item Stromchiffren sind oft klein und schnell und deshalb attraktiv für Anwendungen,
        ...
        64 Bit nicht mehr als sicher. Obwohl die vollständige Schlüsselsuche immer noch
        aufwändig ist, wurden viele Angriffe gezeigt, welche die Verschlüsselung
        in nahezu Echtzeit brechen können.
...
Es gibt jedoch auch hier Einschränkungen, welche in der Praxis entstehen und
...
Folge von Bit aussehen muss. Das Theme der Zufallszahlen soll deshalb
...
Eigenschaft von Stromchiffren. Im Folgenden werden einige
...
erzeugen Zahlen, welche in keiner Weise vorhersehbar und reproduzierbar sind. Wirft man
eine Münze 100-mal und erzeugt eine Folge von 100 Bit, ist es quasi
