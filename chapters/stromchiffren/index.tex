...
\begin{proof}
  \begin{align*}
    y_i  & \equiv x_i + k_i \pmod{2}          \\
    -x_i & \equiv -y_i + k_i \pmod{2}         \\
    x_i  & \equiv y_i + k_i \pmod{2} \qedhere
  \end{align*}
\end{proof}
\noindent
...
Es gibt jedoch auch hier Einschränkungen, welche in der Praxis entstehen.
...
Das Generieren dieser Folge ($k_1,k_2,\dots,k_n$) bildet
