...
In diesem Kapitel sollen anhand von Stromchiffren einige Definition eingeführt
...
\begin{enumerate}[itemsep = 0pt]
  \item \textbf{Konfusion} ist eine Verschlüsselungsoperation mit der Aufgabe den
        Zusammenhang von Schlüssel und Geheimtext unklar zu machen. Eine
        beliebte Methode ist die Bitsubstitution, welche sowohl in \acs{des} als auch
        \acs{aes} verwendet wird.
  \item \textbf{Diffusion} ist eine Verschlüsselungsoperation mit der Aufgabe den Einfluss
        an einer Stelle des Klartextes, über den gesamten Geheimtext zu verteilen, mit dem Ziel
